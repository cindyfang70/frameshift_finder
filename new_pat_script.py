...
for tg_organism in shared_by_all:
    ...
    if tg_organism.tg_sequence != None:
        ...
        try:
            ...
            pass
        # if organism.iscDNA:
        #     found_region = found_region.reverse_complement()
        print(found_region)
        print(tg_organism.extended_tg_sequence)
        read_start = tg_organism.extended_tg_sequence.find(found_region)
        print(read_start)
        onwards = tg_organism.extended_tg_sequence[read_start:]
        print(onwards)
        if "TAG" in onwards or "TAA" in onwards or "TGA" in onwards:
            print("has stop codon")
            print(tg_organism.extended_tg_sequence.find("TAG"))
            print(tg_organism.extended_tg_sequence.find("TAA"))
            print(tg_organism.extended_tg_sequence.find("TGA"))
